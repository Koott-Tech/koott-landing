      ...
      <div className="container">
        <div className="mx-auto flex max-w-screen-xl flex-col justify-between gap-10 lg:flex-row lg:gap-20">
          ...
          <div className="mx-auto flex max-w-screen-md flex-col gap-6 rounded-lg border p-10 bg-white">
            ...
            <div className="grid w-full items-center gap-1.5">
              <Label htmlFor="condition">What do you feel?</Label>
              <select 
                id="condition" 
              ...
              >
                ...
                <option value="unclear">I am unclear about my condition</option>
              </select>
            </div>
            <div className="grid w-full items-center gap-1.5">
              ...
              <div className="flex gap-2">
                ...
                <Input type="tel" id="phone" placeholder="Phone Number" className="flex-1" />
              </div>
            </div>
